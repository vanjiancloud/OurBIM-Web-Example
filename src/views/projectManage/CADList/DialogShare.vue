<template>
  <el-dialog title="分享图纸链接" :visible.sync="dialogVisible" width="50%" :before-close="hide"
    ...
    <el-form :model="form" ref="form" label-width="100px">
      ...
      <div class="shareContent" v-if="getShareUrl">
        ...
        <el-form-item label="链接：">
          ...
          <el-button type="primary" class="btn" v-clipboard:copy="form.url" v-clipboard:success="onCopyUrl"
...
import { shareCad } from '@/api/projectManage/CADList.js'
export default {
  components: {},
  props: {},
  data() {
