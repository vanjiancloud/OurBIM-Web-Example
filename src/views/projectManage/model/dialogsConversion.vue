<!-- 重新转换 -->
<template>
  <el-dialog title="重新转换" :visible.sync="dialogVisible" width="580px" :before-close="hide"
    ...
    submit() {
      this.$refs.form.validate((valid) => {
        ...
        let data = {
          ...
          modelActorLimitNum: this.form.modelActor ? this.form.modelActorLimitNum : '',
          singleActorLimitNum: this.form.singleActor ? this.form.singleActorLimitNum : '',
