<template>
  <el-dialog title="协同模式" :visible.sync="dialogVisible" :before-close="closeDialog" :close-on-press-escape="false"
    width="35%">
    <el-row v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading">
        ...
        <div class="nick-input">
          <el-input placeholder="请输入内容" v-model="teamUrl" readonly>
            <template slot="append">
              <el-button type="info" class="btn" v-clipboard:copy="teamUrl" v-clipboard:success="onCopyUrl"
      ...
      <div class="code-img-row">
        ...
        <div class="code-row-text">
          ...
          <div>
            <el-button type="primary" class="btn" v-clipboard:copy="teamUrl" v-clipboard:success="onCopyUrl"
              v-clipboard:error="onErrorUrl">复制二维码</el-button>
          </div>
        </div>
      </div>
    </el-row>
