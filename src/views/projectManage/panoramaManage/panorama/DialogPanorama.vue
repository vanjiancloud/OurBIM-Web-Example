<!-- 上传\编辑贴图 -->
<template>
  <el-dialog :title="title + '全景图'" :visible.sync="dialogVisible" :close-on-click-modal="false" append-to-body
    width="460px" :before-close="hide">
    <el-form ref="form" :style="{ 'width': '90%' }" :model="form" :rules="rules" label-width="100px">
      <el-form-item label="全景图名称:" prop="textureName">
      ...
      <el-form-item label="全景图片:" prop="fileUpload">
