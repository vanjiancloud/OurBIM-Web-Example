<template>
  <el-tabs v-model="activeName" class="tabs">
    ...
    <!-- 材质库 -->
    <Meterial ref="MeterialRef" v-if="activeName === '1'" :total.sync="total" :groupName.sync="groupName" />
    <!-- 贴图库 -->
    <Chartlet ref="Chartlet" v-if="activeName === '2'" :total.sync="total" :groupName.sync="groupName" />
    <!-- 标签库 -->
    <Tag ref="Tag" v-if="activeName === '3'" :total.sync="total" :groupName.sync="groupName" />
  </el-tabs>
</template>

<script>
import Components from './components.vue'
import Meterial from './meterial/index.vue'
import Chartlet from './chartlet.vue'
import Tag from './tag.vue'
export default {
  components: { Chartlet, Components, Meterial, Tag },
  props: {},
  data() {
    return {
      activeName: '0',
