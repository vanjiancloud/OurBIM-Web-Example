    ...
    <div class="flexColumnCenter">
      <el-form ref="passwordForm" :model="passwordForm" label-position="right" label-width="130px" :rules="rules">
        <el-form-item label="原密码：" prop="oldPassword">
          <el-input v-model="passwordForm.oldPassword" show-password class="formInputWidth"
            placeholder="请输入原密码"></el-input>
        </el-form-item>
        <el-form-item label="新密码：" prop="newPassword">
          <el-input v-model="passwordForm.newPassword" show-password class="formInputWidth"
            placeholder="请输入新密码"></el-input>
        </el-form-item>
        <el-form-item label="确认密码：" prop="confirmPassword">
          <el-input v-model="passwordForm.confirmPassword" show-password class="formInputWidth"
