<!-- 进程详情 -->
<template>
    <el-dialog title="进程详情" :visible.sync="dialogVisible" :close-on-click-modal="false" append-to-body width="530px" :before-close="hide">
        <div class="table">
            <div class="tableItem">
...
<script>
import { detail } from "@/api/server/terminal.js"
export default {
    components: { },
    props: {
