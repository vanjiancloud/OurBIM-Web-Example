...
-->
<template>
  <el-dialog title="GIS遮罩图元设置" :visible.sync="dialogVisible" width="30%" :before-close="hide"
    :modal-append-to-body="true" :append-to-body="true" :close-on-click-modal="true">
