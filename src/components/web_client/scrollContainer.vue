  ...
  methods: {
    ...
    handleMouseWheel(e) {
      ...
      this.bar.style.transform =
        "translateY(" +
        (this.box.scrollTop + this.box.scrollTop / this.ratio) +
        "px)";
    },
    /**
     * 鼠标按下
    ...
    handleMouseEnter() {
      ...
      if (this.box.scrollHeight > this.box.offsetHeight) {
        ...
        this.ratio =
          (this.box.scrollHeight - this.box.offsetHeight) /
          (this.box.offsetHeight - this.barHeight);
        this.bar.style.transform =
          "translateY(" +
          (this.box.scrollTop + this.box.scrollTop / this.ratio) +
          "px)";
