    ...
    <div class="roam_navigate">
        ...
        <div class="middle">
            <el-radio-group v-model="radio" class="singleSelect" @change="changeRadio">
                <el-radio :label="2" class="needBlock" v-if="$route.query.isGis !== 'true'"><span class="viewModel">{{personView[0].name}}</span></el-radio>
...
export default {
    ...
    data(){
        return {
            ...
            params:{
                ...
                viewMode:this.$route.query.isGis === 'true'?1:2,
                projectionMode:'1',
    ...
    created(){
        this.radio = this.$route.query.isGis === 'true'?1:2
    //   this.threeView();
    },
    mounted(){
